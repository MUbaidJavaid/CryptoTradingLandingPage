      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/10 border border-green-500/30 rounded-full mb-6">
            ...
            <span className="text-green-400 text-sm font-medium">Performance Metrics</span>
          </div>
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            See how data-driven crypto trading strategies can generate returns. Performance shown 
            is illustrative based on historical market conditions.
          </p>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between mb-8">
            <div>
              <h3 className="text-2xl font-bold text-white mb-2">Weekly Growth Performance</h3>
              <p className="text-gray-400">Illustrative weekly profit percentage based on historical data</p>
            </div>
        ...
        >
          ...
          <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-xl rounded-2xl p-8 border border-white/10">
            <h3 className="text-2xl font-bold text-white mb-2">Crypto vs Traditional Investing</h3>
            <p className="text-gray-400 mb-6">Monthly return comparison (illustrative)</p>
            ...
            <div className="flex items-center justify-center gap-8 mt-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-300">Traditional Investing</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-green-500/20 to-green-600/20 border border-green-500/40 rounded-2xl p-6">
              ...
              <h4 className="text-xl font-bold text-white mb-2">Potential Monthly ROI</h4>
              <div className="text-4xl font-bold text-green-400 mb-2">12-25%</div>
              <p className="text-gray-300">Based on active trading strategies in favorable market conditions</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/20 border border-blue-500/40 rounded-2xl p-6">
              ...
              <h4 className="text-xl font-bold text-white mb-2">Diversified Approach</h4>
              <div className="space-y-3 mt-4">
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-2">
                    <div className="bg-gradient-to-r from-blue-400 to-blue-500 h-2 rounded-full" style={{ width: '30%' }}></div>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-sm mb-1">
            ...
            <div className="bg-gray-800/40 backdrop-blur-sm border border-yellow-500/30 rounded-xl p-4">
              <p className="text-xs text-yellow-400/80 leading-relaxed">
                <strong>Disclaimer:</strong> Performance data shown is illustrative and based on historical market 
                conditions. Past performance does not guarantee future results. Cryptocurrency trading 
