...
const stats = [
  { icon: Users, value: '150,000+', label: 'Active Traders', color: 'text-blue-400' },
  { icon: TrendingUp, value: '2.4M+', label: 'Trades Analyzed', color: 'text-green-400' },
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-yellow-500/10 border border-yellow-500/30 rounded-full mb-6">
            ...
            <span className="text-yellow-400 text-sm font-medium">Trusted by Thousands</span>
          </div>
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Thousands of traders trust our platform for their crypto trading journey. 
        ...
        >
          {stats.map((stat, index) => (
            <div key={index} className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-sm border border-white/10 rounded-2xl p-8 text-center">
        ...
        >
          <div className="inline-flex items-center gap-4 bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-500/30 rounded-full px-8 py-4">
            ...
            <div className="text-left">
              <div className="text-lg font-semibold text-white">4.9/5 Average Rating</div>
              <div className="text-sm text-gray-400">Based on 12,400+ reviews</div>
            </div>
          </div>
        </motion.div>
      </div>
