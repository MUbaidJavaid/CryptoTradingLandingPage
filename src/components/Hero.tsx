  ...
  return (
    <div className='relative min-h-screen flex items-center justify-center overflow-hidden'>
      ...
      <div className='absolute inset-0 overflow-hidden'>
        ...
        ></div>
        <div
          className='absolute w-96 h-96 bg-green-500/20 rounded-full blur-3xl -bottom-48 left-1/2 animate-pulse'
        ...
        <div className='grid lg:grid-cols-2 gap-12 items-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8 leading-relaxed'>
              Join thousands of successful investors who trust our expert
              trading team. Simply invest and let our professional traders do
              all the work. Consistent daily profits, minimal effort, maximum
              growth.
            </p>
