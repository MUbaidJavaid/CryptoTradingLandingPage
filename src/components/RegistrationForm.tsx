        ...
        <div className='max-w-2xl mx-auto relative z-10'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-6'>
              Welcome to the future of crypto trading. Our team will contact you
              shortly to get you started.
            </p>

            <div className='bg-black/40 border border-white/10 rounded-xl p-6 mb-6'>
              <p className='text-gray-300 leading-relaxed'>
                Check your email for a verification link and next steps to
                activate your account. Get ready to unlock the potential of
                crypto markets!
              </p>
            </div>
            ...
            <div className='flex items-center justify-center gap-2 text-green-400'>
              ...
              <span className='text-sm'>
                Your information has been securely encrypted
              </span>
            </div>
          </motion.div>
        </div>
    ...
    >
      ...
      <div className='max-w-6xl mx-auto relative z-10'>
        ...
        >
          ...
          Fill out the form and get immediate access to our powerful crypto trading platform. Don’t wait—start trading today.
          </p>
        </motion.div>
          ...
          >
              ...
              <div className='space-y-4'>
                <div className='flex items-start gap-4'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-400'>
                      Get immediate access to our advanced trading dashboard and
                      tools
                    </p>
                  </div>
                </div>
                ...
                <div className='flex items-start gap-4'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-400'>
                      Receive AI-powered trading signals and market analysis
                      24/7
                    </p>
                  </div>
                </div>
                ...
                <div className='flex items-start gap-4'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-400'>
                      24/7 customer support from crypto trading experts
                    </p>
                  </div>
                </div>
                ...
                <div className='flex items-start gap-4'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-400'>
                      Access to trading guides, webinars, and market insights
                    </p>
                  </div>
                </div>
                ...
                <div className='flex items-start gap-4'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-400'>
                      Join our exclusive community of successful traders
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className='bg-gradient-to-br from-green-500/10 to-blue-500/10 border border-green-500/30 rounded-2xl p-6'>
              ...
              <p className='text-gray-300 leading-relaxed mb-4'>
                Register now and get 3 months of premium market analysis
            ...
            <div className='bg-gray-800/40 backdrop-blur-sm border border-white/10 rounded-xl p-4'>
              <p className='text-xs text-gray-400 leading-relaxed'>
                ...
                about our crypto trading platform. We respect your privacy and
